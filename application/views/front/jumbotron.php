        ...
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="width:100%; height: 500px !important;">
                    <img src="<?= base_url('assets/img/posting/jumbotron/') . $j['image1']; ?>"
                ...
                <div class="carousel-item" style="width:100%; height: 500px !important;">
                    <img src="<?= base_url('assets/img/posting/jumbotron/') . $j['image2']; ?>"
                        class="d-block w-100" alt="">
                    <div class="carousel-container">
                        <div class="carousel-content container">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item" style="width:100%; height: 500px !important;">
                    <img src="<?= base_url('assets/img/posting/jumbotron/') . $j['image3']; ?>"
                        class="d-block w-100" alt="">
                    <div class="carousel-container">
                        <div class="carousel-content container">
